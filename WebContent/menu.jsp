...
<header>
        <div class="container">
                ...
                <ul class="main-menu font-mountainsre" id="main-menu">
                        ...
                        <li><a href="menu.jsp">SERVICES</a></li>
...
try{
	Class.forName("com.mysql.jdbc.Driver");
			String url = "jdbc:mysql://localhost:3306/homechef";
	...
	%>
	   ...
	   <div class="col-md-6">
                                <div class="sided-90x mb-30 ">
                                        ...
                                        <div class="s-right">
                                                <h5 class="mb-10"><b><%=n %></b><b class="color-primary float-right">$<%=p %>.00</b></h5>
                                                <p class="pr-70"><%=d %> </p>
                                        </div><!--s-right-->
                                </div><!-- sided-90x -->
                        </div><!-- food-menu -->
...
try{
  ...
  Connection cn= DriverManager.getConnection(url,"root","root");
	Statement st = cn.createStatement();
	ResultSet rs = st.executeQuery("select*from pasta");
...
while(rs.next())
{
	...
	l=rs.getString("name").trim();
	q=rs.getString("description").trim();
	r=rs.getString("price").trim();
	...
	%>
	   ...
	   <div class="col-md-12 col-lg-6">
                                <div class="sided-220x responsive mb-30 left-text center-sm-text">
                                        ...
                                        <div class="s-right">
                                                <h5><%=l %></h5>
                                                <h4 class="mtb-10"><b class="color-primary">$<%=r %>.00</b></h4>
                                                <p><%=q %> </p>
                                        </div><!--s-right-->
                                </div><!-- sided-90x -->
                        </div><!-- col-md-6 -->
